...
**Quando due fonti citate non danno lo stesso dato, non si sceglie: si sale di livello.** Nella seconda infornata scritta con questa sezione, una scheda dava la data di uscita del singolo al 22 luglio 1973 perché così diceva l'articolo del racconto; un'altra fonte già citata nella stessa scheda ne dava un'altra, e nessuno se n'era accorto. La divergenza si è chiusa solo aprendo il **sito ufficiale dell'artista** — livello A — che dice 22 giugno. La regola operativa: per l'anagrafica (data, etichetta, autori, classifiche), se due fonti già citate non concordano **non si tiene la più comoda né quella che sembra più autorevole a occhio: si cerca una fonte di livello A** — sito ufficiale, etichetta, archivio della classifica, voce dell'album. Se una fonte A non esiste, si applica la R5 e la divergenza si scrive nella scheda invece di essere risolta in silenzio.
