...
| F33 — Logo con più presenza | completato | 26 agosto 2026 | Testata: 168px→224px desktop, 128px→176px mobile. Apertura home: `clamp(190,24vw,300)`→`clamp(260,32vw,440)`. Verificato che la ricerca resti visibile senza scorrere: 1280px margine 431→800px, 375px margine 414→812px. Nessun overflow, nessun errore console |
