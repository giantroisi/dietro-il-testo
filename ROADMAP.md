...
| F33 — Logo con più presenza | da fare | 26 agosto 2026 | Oggi 168px in testata (128px sotto 820px) e `clamp(190px, 24vw, 300px)` in apertura. L'autore lo vuole più grande, citando Sottolineature. Riapre la conclusione di F24 ("ingrandirlo non è la soluzione"): eseguire, ma tenendo il criterio F24 — ricerca visibile senza scorrere. Vedi `BRIEF-F33-F38.md` |
